...
PlayerEvents.loggedIn(event => {
  ...
  p.server.scheduleInTicks(20, () => {
    try {
      ...
      p.tell('§7第一步：朝 §b东北§7 方向走到发光的独石碑（坐标 §f(26, ~, -126)§7）——靠近会自动获得 2 粒上古之种。');
      p.tell('§7第二步：种下种子 → 成熟后加工成文明精华 → 配合金锭/绿宝石合成 §b星门钥匙§7（JEI 搜“星门钥匙”）。');
      p.tell('§7第三步：去旁边的黑曜石星门（§f(0, ~, -100)§7），手持钥匙右键 §b中央紫色发光核心§7 → 跃迁铁锈星！');
      p.tell('§7按 §eK§7 打开 §6任务书§7（树状主线图，跟着箭头走就行）；§eQ§7 是图鉴百科；§eJ§7 是配方手册。');
      p.tell('§7手册遗失可用 书+羽毛 合成；任务书内每个任务都写明 坐标/做法/背景。');
    } catch (e) {
